// frontend/src/pages/components/AdminNotificationBell.js
...
function AdminNotificationBell({ userId }) {
...
const fetchUnreadCount = async () => {
  ...
  const getNotificationIcon = (type) => {
    switch(type) {
      ...
      case 'report_issue': return '⚠️';
      case 'counsellor_request': return '👨‍🏫';
      case 'report_group': return '👥';
      case 'test': return '🧪';
      default: return '📬';
    }
  };
  ...
  const getNotificationColor = (type) => {
    switch(type) {
      case 'report_post': return '#ef4444';
      case 'report_issue': return '#f59e0b';
      case 'counsellor_request': return '#3b82f6';
      case 'report_group': return '#8b5cf6';
        ...
        <div style={{
          ...
          <div style={{ 
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
              <span style={{ fontWeight: 600, fontSize: '14px' }}>Admin Notifications</span>
              {unreadCount > 0 && (
                <span style={{
                  background: '#ef4444',
                  color: 'white',
